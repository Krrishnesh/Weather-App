...
function getWeather(){
    ...
    if(i === 1){
      city = "London";
      document.getElementById("London").style.border = "3px solid rgb(9, 114, 9)";
    } 
    if(i === 2) {
      city = "New York";
      document.getElementById("New York").style.border = "3px solid rgb(9, 114, 9)";
    }
    if(i === 3) {
      city = "Los Angeles";
      document.getElementById("Los Angeles").style.border = "3px solid rgb(9, 114, 9)";
    }
    if(i === 4) {
      city = "Las Vegas";
      document.getElementById("Las Vegas").style.border = "3px solid rgb(9, 114, 9)";
    }

    //Fetch Weather data by calling an api 
